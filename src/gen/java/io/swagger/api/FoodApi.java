...
@javax.annotation.Generated(value = "io.swagger.codegen.v3.generators.java.JavaResteasyServerCodegen", date = "2021-03-09T22:27:23.118Z[GMT]")public class FoodApi  {
    ...
    public Response foodBrandedBarcodePhpGet( @NotNull  @QueryParam("code") String code,  @QueryParam("user_id") String userId,@Context SecurityContext securityContext)
    throws NotFoundException {
        return service.foodBrandedBarcodePhpGet(code,userId,securityContext);
    }
    @GET
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(responseCode = "500", description = "**Server error** - Internal server error, request failed, or base error. *Please **[contact us](https://chompthis.com/api/ticket-new.php)** if you see this.* ") })
    public Response foodBrandedNamePhpGet( @NotNull  @QueryParam("name") String name,  @QueryParam("limit") Integer limit,  @QueryParam("page") Integer page,  @QueryParam("user_id") String userId,@Context SecurityContext securityContext)
    throws NotFoundException {
        return service.foodBrandedNamePhpGet(name,limit,page,userId,securityContext);
    }
    @GET
    ...
    throws NotFoundException {
        return service.foodBrandedSearchPhpGet(allergen,brand,category,country,diet,ingredient,keyword,mineral,nutrient,palmOil,trace,vitamin,limit,page,userId,securityContext);
    }
    @GET
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(responseCode = "500", description = "**Server error** - Internal server error, request failed, or base error. *Please **[contact us](https://chompthis.com/api/ticket-new.php)** if you see this.* ") })
    public Response foodIngredientSearchPhpGet( @NotNull  @QueryParam("find") String find,  @QueryParam("limit") Integer limit,  @QueryParam("user_id") String userId,@Context SecurityContext securityContext)
    throws NotFoundException {
        return service.foodIngredientSearchPhpGet(find,limit,userId,securityContext);
    }
}
